...
//    private  HashMap<Element, ElementGroup> queryElemMap = new HasMap<Element, ElementGroup>(); 
...
//        System.out.println("[RemoveOpTransform::transform(ElementTriplesBlock arg0)] " + arg0.toString());
//        System.out.println("");
        return arg0;
    }
...
//        System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg0) arg0 " + arg0.toString());
//        System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg1) arg1 " + arg1.toString());
...
//                boolean isElementGroupEmpty = isElementGroupEmpty((ElementGroup) elem);
                ...
                if (isElementGroupEmpty) {
                    System.out.println("");
//                    System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg1)] ElementGroup " + ((ElementGroup) elem).toString() + "IS GOING TO BE REMOVED!!!!");
                    itr.remove();
//                    ElementGroup el2 = new ElementGroup();
//                    el2.getElements().addAll(arg1);
//                    return el2;
...
//                        System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg1)] THE " + ((ElementFilter) elem).toString() + "IS GOING TO BE REMOVED!!!");
                        //Expr e = new NodeValueBoolean(true);
                        //ElementFilter newFilter = new ElementFilter(e);
                        //return newFilter;
//                        System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg1)] arg1 BEFORE REMOVING " + arg1.toString());
                        //itr.remove();
                        if (!existAnotherTripleWithThatVariable(var, arg1)) {
                            itr.remove();
//                            System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] arg1 AFTER REMOVING " + arg1.toString());
                            break;
                        }
...
//                System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] ElementUnion isUnionBothSidesEmpty " + isUnionBothSidesEmpty);
...
//                    return el2;
                ...
                //System.out.println("[RemoveOpTransform::transform(ElementGroup arg0, List<Element> arg1)] ElementUnion ");
                //return (ElementUnion) elem;
            }
        }// End of While

        //With this code I am saying the following: make effective all the modifications that 
...
//        System.out.println("[RemoveOpTransform::transform(ElementGroup arg0)] arg1 " + arg1.toString());
//        System.out.println("");
        //return arg0New;
//        return arg0;
    }
...
//            Element elem = itr.next();
//            if (elem instanceof ElementOptional) {
//                boolean isElementOptionalEmpty = isElementOptionalEmpty((ElementOptional) elem);
//                if (isElementOptionalEmpty) {
//                    System.out.println("");
//                    System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] ElementOptional 777777777  " + ((ElementOptional) elem).toString() + " IS GOING TO BE REMOVED AS IT IS EMPTY!!!!");
//                    itr.remove();
//                }
...
//                if (isElementGroupEmpty) {
//                    System.out.println("");
//                    System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] ElementGroup " + ((ElementGroup) elem).toString() + "IS GOING TO BE REMOVED!!!!");
//                    itr.remove();
//                    ElementGroup el2 = new ElementGroup();
//                    el2.getElements().addAll(arg1);
//                    return el2;
...
//                    //...if it does then we have to delete the entire FILTER expression
//                    if (tpVars.contains(var)) {
//                        System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] THE " + ((ElementFilter) elem).toString() + "IS GOING TO BE REMOVED!!!");
//                        //Expr e = new NodeValueBoolean(true);
//                        //ElementFilter newFilter = new ElementFilter(e);
//                        System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] arg1 BEFORE REMOVING " + arg1.toString());
//
//                        itr.remove();
//
//                        System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] arg1 AFTER REMOVING " + arg1.toString());
...
////                System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] ElementUnion 2222222 " + ((ElementUnion) elem).toString());
//                boolean isUnionBothSidesEmpty = isUnionBothSidesEmpty1((ElementUnion) elem);
//                System.out.println("[RemoveOpTransform::visit(ElementGroup arg0)] ElementUnion isUnionBothSidesEmpty " + isUnionBothSidesEmpty);
//                if (isUnionBothSidesEmpty) {
//                    itr.remove();
...
//    }
    ...
    public Element transform(ElementPathBlock eltPB) {
        if (eltPB.isEmpty()) {
            //System.out.println("[RemoveOpTransform::transform(ElementPathBlock arg0)] ElementPathBlock IS EMPTY:: " + eltPB.toString());
            return eltPB;
        }
//        System.out.println("[RemoveOpTransform::transform(ElementPathBlock arg0)] ElementPathBlock:: " + eltPB.toString());
        Iterator<TriplePath> l = eltPB.patternElts();
        while (l.hasNext()) {
            TriplePath tp = l.next();
            if (tp.asTriple().matches(this.triple)) {
                l.remove();
//                System.out.println("[RemoveOpTransform::transform(ElementPathBlock arg0)] ElementPathBlock:: " + tp.toString() + " TRIPLE JUST REMOVED!!!");
//                //System.out.println("[RemoveOpTransform::transform(ElementPathBlock arg0)] TRIPLE JUST REMOVED!!! ");
//                System.out.println("");
...
//        System.out.println("[RemoveOpTransform::transform(ElementFilter arg0)] arg0 " + arg0.toString());
//        System.out.println("[RemoveOpTransform::transform(ElementFilter arg1)] arg1 " + arg1.toString());
//
//        //...get the variables of the triple pattern that we want to delete
//        Set<Var> tpVars = new HashSet();
//        Node subj = this.triple.getSubject();
...
//            //..if it does then we have to delete the entire FILTER expression
//            if (tpVars.contains(var)) {
//                System.out.println("[SQRemoveTripleVisitor::visit(ElementFilter arg0)] FILTER TO BE REMOVED!!!HOW? ");
//                Expr e = new NodeValueBoolean(true);
//                ElementFilter newFilter = new ElementFilter(e);
//                return newFilter;
//            }
...
//        System.out.println("[RemoveOpTransform::transform(ElementAssign arg0)] " + arg0.toString());
//        System.out.println("");
...
//        System.out.println("[RemoveOpTransform::transform(ElementBind arg0)] " + arg0.toString());
//        System.out.println("");
        return arg0;
    }
...
//        System.out.println("[RemoveOpTransform::transform(ElementData arg0)] " + arg0.toString());
//        System.out.println("");
        return arg0;
...
//        System.out.println("[RemoveOpTransform::transform(ElementDataset arg0)] " + arg0.toString());
//        System.out.println("");
        return arg0;
    }
...
//        System.out.println("[RemoveOpTransform::transform(ElementUnion arg0)] arg0  yyyyyy " + arg0.toString());
//        System.out.println("[RemoveOpTransform::transform(ElementUnion arg0)] arg1 yyyyyy " + arg1.toString());
//        System.out.println("");
        for (Element e : arg1) {
...
////
////                //               System.out.println("[RemoveOpTransform::visit(ElementUnion arg0, List<Element> arg1)] ONE SIDE OF THE UNION  "+((ElementGroup) elem).getElements().toString());                              
////                System.out.println("[RemoveOpTransform::visit(ElementUnion arg0, List<Element> arg1)] ONE SIDE OF THE UNION  " + elemList.get(0).toString());
////                if (((ElementGroup) elem).getElements().isEmpty()) {
////                    System.out.println("[RemoveOpTransform::visit(ElementUnion arg0, List<Element> arg1)] ONE SIDE OF THE UNION IS EMPTY !!!");
////                }
////            }
//        }
        return arg0;
...
//        System.out.println("[RemoveOpTransform::transform(ElementOptional arg0)] 55555555555555555 " + arg0.toString());
//        System.out.println("");
...
//        System.out.println("[RemoveOpTransform::transform(ElementNamedGraph arg0)] ElementNamedGraph arg0 " + arg0.toString());
//        System.out.println("[RemoveOpTransform::transform(ElementNamedGraph arg0)] Node arg1 " + arg1.toString());
//        System.out.println("[RemoveOpTransform::transform(ElementNamedGraph arg0)]Element arg2 " + arg2.toString());
//        System.out.println("");
        return arg0;
    }
...
//        System.out.println("[RemoveOpTransform::isUnionBothSidesEmpty]elemListUnion.size() " + elemListUnion.size());
//
//        if (elemListUnion.size() == 2) {
//            for (int i = 0; i < elemListUnion.size(); ++i) {
//                if (i == 0) {
//                    if ((((ElementGroup) elemListUnion.get(i)).getElements().size() == 1)) {//getElements().size() == 1)) {
...
//                        System.out.println("[RemoveOpTransform::isUnionBothSidesEmpty] " + elList.toString());
//                    }
//                }
//                if (i == 1) {
//                    if ((((ElementGroup) elemListUnion.get(i)).getElements().size() == 1)) {//getElements().size() == 1)) {
...
//        }
//
//        System.out.println("[RemoveOpTransform::isUnionBothSidesEmpty] BEFORE RETURN leftSide " + leftSide);
//        System.out.println("[RemoveOpTransform::isUnionBothSidesEmpty] BEFORE RETURN rightSide " + rightSide);
//
...
//                if ((((ElementGroup) left).getElements().size() == 1) && (((ElementGroup) right).getElements().size() == 1)) {
//                    Element elLeft = ((ElementGroup) left).getElements().get(0);
//                    Element elRight = ((ElementGroup) right).getElements().get(0);
//                    if ((elLeft instanceof ElementPathBlock) && (elRight instanceof ElementPathBlock)) {
...
//        HashMap<Element, ElementGroup> queryElemMapResult = new HashMap<Element, ElementGroup>();
//
...
//        System.out.println("[RemoveOpTransform::buildQueryElementMap] gpeVisitor.getQueryGPE()  " + qOGPE.toString());
//        System.out.println("[RemoveOpTransform::buildQueryElementMap] qOGPE.size()  " + qOGPE.size());
//
//        //List<Element> elemList = arg0.getElements();
...
//                System.out.println("[RemoveOpTransform::existAnotherTripleWithThatVariable] 1111  " + triplePath.toString());
