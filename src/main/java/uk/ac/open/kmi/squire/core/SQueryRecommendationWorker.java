...
import uk.ac.open.kmi.squire.querytemplate.IQueryTemplate;
import uk.ac.open.kmi.squire.querytemplate.SelectQueryTemplate;
...
import uk.ac.open.kmi.squire.treequerypatterns.ElementPathBlockVisitor;
import uk.ac.open.kmi.squire.treequerypatterns.QTTree;
...
//        System.out.println("[SQueryRecommendationWorker, queryRecommendation()]We are processing the query " + this.queryString);
//        IQueryTemplate qT = new SelectQueryTemplate(queryString, rdfd1, rdfd2);
//        Query qt = qT.generateQueryTemplate();
//        System.out.println("[SQueryRecommendationWorker::queryRecommendation()] This is the query Template" + qt);
//
...
//        System.out.println(" ");
//
//        System.out.println("[SQueryRecommendationWorker, queryRecommendation()]We are processing the query ");
...
//        System.out.println(" ");
//        System.out.println("[SQueryRecommendationWorker, queryRecommendation()] which has got the following list of triple patterns ");
...
//
////      System.out.println("1111111111111111111 "+rdfd2.getPropertySet().toString());
...
//    }
    ...
    //This is working with TreeNode<Query>, but does not manage the removal operation.
...
//            throw new QueryParseException("[SQueryRecommendationWorker::queryRecommendation3] The input query is not parsable!!!", -1, -1);
//        }
...
//                        
// 
//            qr.printQueryTemplateTree1(qr.getRootTemplate(), 0);//.printQueryTemplateTree(qr.getRootTemplate(), 0);//evaluateQTTree
//            
//            
//        } else {
//            System.out.println("[SQueryRecommendationWorker::queryRecommendation3]The input query is not satisfiable w.r.t the input dataset... ");     
//        }
//
////      // building the tree of specialize queries. 
////        //qttree.specializeToQueryInstance(qttree.getRootTemplate());
...
//    }
    ...
    //This is UNDER DEVELOPMENTS and working with TreeNode<DataNode>, we are going to include the management of the removal operation too.
...
//            query = QueryFactory.create(queryString);
//        } catch (org.apache.jena.query.QueryParseException ex) { //QueryParseException 
//            throw new QueryParseException("[SQueryRecommendationWorker::queryRecommendation4] The input query is not parsable!!!", -1, -1);
//        }
//        //...checking if the input query is satisfiable w.r.t. D1 ....
//        SPARQLQuerySatisfiable qs = new SPARQLQuerySatisfiable();
//        if (qs.isSatisfiableWRTResults(query, rdfd1)) {
...
//            
//            System.out.println(" ");
//            System.out.println("[SQueryRecommendationWorker::queryRecommendation4] Original Query ");
...
//
//            System.out.println(" ");
//            System.out.println("[SQueryRecommendationWorker::queryRecommendation4] We are specializing the input query ... ");
...
//            
//        } else {
//            System.out.println("[SQueryRecommendationWorker::queryRecommendation4]The input query is not satisfiable w.r.t the input dataset... ");     
//        }
//
//        return resultQueryList;
//    }
    ...
    public List<QueryScorePair> queryRecommendation5() {
        ...
        try {
            ...
            throw new QueryParseException("[SQueryRecommendationWorker::queryRecommendation5] THE SOURCE QUERY is not parsable!!!", -1, -1);
        }
        //...checking if the input query is satisfiable w.r.t. D1 ....
        SPARQLQuerySatisfiable qs = new SPARQLQuerySatisfiable();
        if (qs.isSatisfiableWRTResults(query, rdfd1)) {
