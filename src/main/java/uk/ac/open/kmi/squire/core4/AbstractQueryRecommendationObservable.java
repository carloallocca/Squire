...
//        if(value){
//            for (IQueryRecommendationObserver observer : observers) {
//                System.out.println("[AbstractQueryRecommendationObservable::notifyQuerySatisfiableValue] The input query is satisfiable w.r.t. D2");
//                observer.updateSatisfiableMessage("[AbstractQueryRecommendationObservable::notifyQuerySatisfiableValue] The input query is satisfiable w.r.t. D2", token);
//            }
//        }
//        else{
//            for (IQueryRecommendationObserver observer : observers) {
//                observer.updateSatisfiableMessage("[AbstractQueryRecommendationObservable::notifyQuerySatisfiableValue] The input query is NOT satisfiable w.r.t. D2",token);
//            }
//        }
    }
