...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        String q1 = "prefix rdfs:<http://www.w3.org/2000/01/rdf-schema#> "
                ...
                + " ex:bob rdf:type ex:ResearchAssociate . "
                + "}";
                
//        Query query = QueryFactory.create(q1);
//        
//        Node node= NodeFactory.createURI("http://www.example.com/onto-schema#ResearchAssociate");
//        Var varTemplate= Var.alloc("ct1");
//        
//        //SPARQLQueryGeneralization qg= new SPARQLQueryGeneralization(query, node, varTemplate);
...
//       SPARQLQueryGeneralization qg= new SPARQLQueryGeneralization();
//       Query genQuery=qg.generalizeFromNodeToVarTemplate(query3, node3, varTemplate3);
