...
import uk.ac.open.kmi.squire.core2.QueryGeneralizer;
import uk.ac.open.kmi.squire.core2.QuerySpecializer;
...
//    private final HashMap<String, TreeNode<T>> treeNodeIndex = new HashMap<>();
    ...
    public QueryRecommendator4(Query query, IRDFDataset d1, IRDFDataset d2,
