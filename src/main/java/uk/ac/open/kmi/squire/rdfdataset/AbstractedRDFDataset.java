...
public class AbstractedRDFDataset implements IRDFDataset {
	...
	public AbstractedRDFDataset(List<String> cSet, List<String> iSet, List<String> opSet, List<String> dpSet,
			List<String> lSet, List<String> rdfVoc) {
	...
	public AbstractedRDFDataset(String dPath, List<String> cSet, List<String> iSet, List<String> opSet,
			List<String> dpSet, List<String> lSet, List<String> rdfVoc) {

		this.datasetPath = dPath;
		classSet = cSet == null ? new ArrayList<>() : cSet;
		objectPropertySet = opSet == null ? new ArrayList<>() : opSet;
		datatypePropertySet = dpSet == null ? new ArrayList<>() : dpSet;
		literalSet = lSet == null ? new ArrayList<>() : lSet;
		individualSet = iSet == null ? new ArrayList<>() : iSet;
		rdfVocabulary = rdfVoc == null ? new ArrayList<>() : rdfVoc;
