...
public class QueryGeneralizer3 implements Callable {
	...
	private Query generalize() {
		...
		// Logger.getLogger(QueryGeneralizer3.class.getName()).log(Level.SEVERE, null,
		// ex);
		// }
	...
	private Var ifPredicateIsNotD2ThenGenerateVariableNew(Node pred) {
		...
		if (pred == null || rdfd2 == null) {
			throw new IllegalStateException(
					"[QueryGeneralizer::ifPredicateIsNotD2ThenGenerateVariable(Node subj)]The subj or rdfd2 is null!!");
		}
		final Var result;
