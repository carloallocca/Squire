...
//        
////        sim=simQuery.computeQueryPatternsSimWithWeighedNonCommonTriplePattern(qR, qR);
//        return sim;
    ...
    private float computeUnionCardinalityVar(List<String> qOvarList, List<String> qRvarList, int intersectionVarCardinality) {
