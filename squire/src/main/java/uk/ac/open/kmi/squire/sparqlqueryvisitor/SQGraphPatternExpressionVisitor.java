	...
	public void visit(ElementPathBlock el) {
		if (el == null) {
			throw new IllegalStateException(
					"[SQGraphPatternExpressionVisitor::visit(ElementPathBlock el)] The ElementPathBlock is null!!");
		}
		// System.out.println("[SQGraphPatternExpressionVisitor::visit(ElementPathBlock
		// el)] The ElementPathBlock contains "+el.toString());
