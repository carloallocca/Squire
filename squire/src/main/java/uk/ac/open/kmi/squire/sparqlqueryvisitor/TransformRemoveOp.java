...
public class TransformRemoveOp implements Transform {
	...
	////
	//// ExprList newExprList = new ExprList(); // contains the translated
	// expressions
	////
	//// OpFilter copiedOpFilter = (OpFilter) OpFilter.filter(exprList,
	// opFilter.getSubOp());
	//// exprList = copiedOpFilter.getExprs();
	////
	//// // for every expression of the filter, apply first DeMorgan-law and then
	// Distributive-law
	//// for (Expr expr : exprList) {
	//// Expr e = new NodeValueBoolean(true);
	//// newExprList.add(e);
	//// }
	//// return copiedOpFilter.filter(newExprList, opFilter);//filter(newExprList,
	// opFilter);
	//
	//
	// /////////////
	...
	public Op transform(OpFilter opFilter, Op subOp) {
		System.out
				.println("[TransformRemoveOp::transform(OpFilter opFilter, Op subOp)] opFilter " + opFilter.toString());
		...
		// ... if the filter contains any variable of the triple that has been removed,
		// then....
		if (isContained) {
			Op newOP;
			Expr e;
	...
	public Op transform(OpLeftJoin opLeftJoin, Op left, Op right) {
		System.out.println(
				"[TransformRemoveOp::transform(OpLeftJoin opLeftJoin, Op left, Op right)] " + opLeftJoin.toString());
		System.out.println("");
	...
	public Op transform(OpUnion opUnion, Op left, Op right) {
		System.out
				.println("[TransformRemoveOp::transform(OpUnion opUnion, Op left, Op right)] left: " + left.toString());
		System.out.println(
				"[TransformRemoveOp::transform(OpUnion opUnion, Op left, Op right)] right: " + right.toString());
		System.out.println("");
	...
	public Op transform(OpDisjunction opDisjunction, List<Op> elts) {
		System.out.println("[TransformRemoveOp::transform(OOpDisjunction opDisjunction, List<Op> elts)] "
