 ...
 * @author carloallocca
 */
public class SQDatatypePropertyAggregator extends AbstractSQAggregator<String> {

	public SQDatatypePropertyAggregator(IRDFDataset d1) {
		if (d1 == null) throw new IllegalArgumentException("The dataset cannot be null");
		this.datasetEntitySet = d1.getDatatypePropertySet();
	}
