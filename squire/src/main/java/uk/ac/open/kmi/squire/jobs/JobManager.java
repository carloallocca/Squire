...
public class JobManager implements IQueryRecommendationObserver {
	...
	/*
	 * It returns a token as it is the method that is going to be called for the Web
	 * Interface, and the token is used later on to do ping...
	 */
	public synchronized String doQueryRecommendation(String qString, IRDFDataset d1, IRDFDataset d2,
		...
		// IQueryRecommendationObservable qSatisfiableObservable = new
		// SPARQLQuerySatisfiable(strToken);
		// qSatisfiableObservable.register(this);
		// IQueryRecommendationObservable datasetsSimObservable = new
		// RDFDatasetSimilarity(strToken);
	...
	public synchronized String doRDFDatasetIndexing(String endPointURI, String graphName) {
		...
		// queryRootDistanceDegree, resultSizeSimilarityDegree,
