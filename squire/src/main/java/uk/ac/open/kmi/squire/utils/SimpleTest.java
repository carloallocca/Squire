...
public class SimpleTest {
	...
	public String executeQuery(String queryText, String acceptFormat) throws Exception {
		...
		String httpQueryString = String.format("query=%s", URLEncoder.encode(queryText, "UTF-8"));
	...
	// public String executeQueryNew(String queryText, String acceptFormat) throws
	// Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		// String urlAddress ="HTTP://BIOPORTAL.BIO2RDF.ORG/SPARQL"; // GOOD FOR
		// http://data.upf.edu/en/sparql_examples
		 ...
		 */
		String query = " SELECT distinct ?p " + " WHERE { " + " ?s ?p ?o . " + " FILTER ((isURI(?o)))" + " } Limit 100";

		// " FILTER (!regex(str(?p),'http://www.openlinksw.com/schemas/virtrdf') )"+// "
		...
		// String response = test.executeQueryNew(query,
		// "application/sparql-results+xml");
