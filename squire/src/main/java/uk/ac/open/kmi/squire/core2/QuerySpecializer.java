...
public class QuerySpecializer {
	...
	public QuerySpecializer(Query qo, Query qr, IRDFDataset d1, IRDFDataset d2, ClassVarMapping cVM,
	...
	private QueryAndContextNode createNewQueryAndContextNodeForInstanciateOp(Query childQueryCopyInstanciated,
			...
			List<VarTemplateAndEntityQoQr> templVarEntityQoQrInstanciatedList) throws Exception {
